...
class AppColors {
  // Primary colors - keep these as the source of truth
  ...
  // Derived colors - lighter/darker variations
  ...
  // Additional colors derived from palette
...
class AppSizes {
  ...
  // Base sizes - keep these as source of truth
  ...
  // Additional layout sizes derived from base
  ...
  // Component sizes derived from buttons
  ...
  // Icon sizes derived from iconSize
...
/// App typography - modern fonts based on design system
class AppTypography {
...
/// App animations - smooth and meaningful animations
class AppAnimations {
